...
#write.csv(epred.ge, file = "output/epreds.csv")
```
...
#ggsave(plot.gescmodel, file = "output/figs/modeleffects.ge.sc.tiff", dpi=300, width=10, height=10)
#ggsave(plot.gescmodel, file = "output/figs/modeleffects.ge.sc.pdf", width=10, height=10)
```
## Fig 2
...
#ggsave(plot.cor, file = "output/figs/model.cor.tiff", dpi=300, width=10, height=12)
#ggsave(plot.cor, file = "output/figs/model.cor.pdf", width=10, height=12)
```
...
#ggsave(plot.spscmodel, file = "output/figs/modeleffects.sp.sc.tiff", dpi=300, width=10, height=10)
#ggsave(plot.spscmodel, file = "output/figs/modeleffects.sp.sc.pdf", width=10, height=10)

plot.spscmodel2 <- plot.sp.tric + plot.sp.tdiv +  
  plot.sp.pric +  plot.sp.pdiv + plot.sp.fric + plot.sp.fdiv + 
  plot_layout(ncol = 2) + plot_annotation(tag_levels = 'a')

#ggsave(plot.spscmodel2, file = "output/figs/modeleffects.sp.sc2.tiff", dpi=300, width=10, height=10)
#ggsave(plot.spscmodel2, file = "output/figs/modeleffects.sp.sc2.pdf", width=10, height=10)
```
...
#ggsave(plot.ge.cwmgf, file = "output/figs/modeleffects.ge.cwmgf.tiff", dpi=300, width=10, height=12)
#ggsave(plot.ge.cwmgf, file = "output/figs/modeleffects.ge.cwmgf.pdf", width=10, height=12)
```
...
#gsave(plot.ge.ranef, file = "output/figs/modelraneffects.ge.tiff", dpi=300, width=10, height=15)
#ggsave(plot.ge.ranef, file = "output/figs/modelraneffects.ge.pdf", width=10, height=15)
```
...
ggsave(plot.sp.ranef, file = "output/figs/modelraneffects.sp.tiff", dpi=300, width=10, height=12)
ggsave(plot.sp.ranef, file = "output/figs/modelraneffects.sp.pdf", width=10, height=12)
```
